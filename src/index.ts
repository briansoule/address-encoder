...
export const formats: IFormat[] = [
  ...
  hexChecksumChain('ARB', 9001),
  hexChecksumChain('BOBA', 9002),
  hexChecksumChain('LOOP', 9003),
  hexChecksumChain('STARK', 9004),
//  Pending SLIP PR Merge https://github.com/satoshilabs/slips/pull/1202  
//  hexChecksumChain('BSC', 9005),
//  hexChecksumChain('AVAXC', 9006),
